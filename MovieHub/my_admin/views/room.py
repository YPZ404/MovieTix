...
def index(request, pIndex=1):
    ...
    for room in roomList:
        print(room.toDict())
    return render(request, 'my_admin/room/index.html', context)


# load room addition form
def add(request):
    return render(request, 'my_admin/room/add.html')
...
def edit(request, roomId=0):
    try:
        ...
        context = {'room': ob}
        return render(request, 'my_admin/room/edit.html', context)
    except Exception as err:
        print(err)
